# # MITgcm_workflow.jl
#
# 	Here we setup, run and plot MITgcm interactively to generate something like this:
#
# ![fig1](https://user-images.githubusercontent.com/20276764/111042787-12377e00-840d-11eb-8ddb-64cc1cfd57fd.png)

using MITgcmTools, ClimateModels, MeshArrays, Printf, GR

# ## Select Model Configuration
#
# Here we select one of the standard MITgcm configurations (or _verification experiments_).
#
# ```
