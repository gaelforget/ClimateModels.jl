...
module SWM
	...
	function contourf(MC::ModelConfig)
		MCdir=pathof(MC)
		ncfile = NetCDF.open(joinpath(MCdir,"run_0001","sst.nc"))
		sst = ncfile.vars["sst"][:,:,:]
		...
		CairoMakie.contourf!(a,collect(1:nx),collect(1:ny),sst_t,
			colormap=:grays,levels=-1.0:0.2:1.0)
...
manifest_format = "2.0"
project_hash = "b7a1be9d89312cb3645a5046d61bad525f0410a5"
...
path = "/Users/gforget/.julia/dev/ShallowWaters"
uuid = "56019723-2d87-4a65-81ff-59d5d8913e3c"
version = "0.5.1"

    [deps.ShallowWaters.weakdeps]
