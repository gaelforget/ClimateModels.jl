...
let
    f_all=demo.plot_all_scenarios(MC)
...
begin
	g,b,_,_=demo.plot(myMC,"tas")
	lines!(b,year,tas,label=MC.configuration,lw=3)
	Legend(g[1, 2], b)
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "d16cbce7297eb503e8037bf7265fc7e5cc1a6eec"
