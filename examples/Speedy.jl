...
begin
    ...
    tmp=demo.read_output(files,myvar,ti)
...
begin
	...
	ncfile = demo.NetCDF.open(joinpath(rundir,"sea_surface_temperature.nc"))
...
manifest_format = "2.0"
project_hash = "1206ab3f559f978bcedf0335cfe5ba2929bc67b6"
