...
begin
	using ClimateModels, PlutoUI, CairoMakie, NetCDF
...
Speedy.write_ini_file(MC,nmonths)
...
begin
	...
	𝑉=ClimateModels.DataFrame(name=String[],long_name=String[],unit=String[],ndims=Int[])
...
ClimateModels.plot_examples(:Speedy_input,ncfile,"sst",to,msk)
...
manifest_format = "2.0"
project_hash = "74c78cef59e92680c52323242131d679fa32abc1"
