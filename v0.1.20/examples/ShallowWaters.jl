...
begin
	...
	parameters=Dict(:nx => 100, :ny => 50, :Lx => 2000e3, :nd=>100) #adjustable parameters
...
begin
	...
	CairoMakie.contourf!(a,collect(1:100),collect(1:50),sst_t,colormap=:grays,colorrange=(-1.0,1.0))
